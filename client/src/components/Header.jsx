...
function Header() {
  ...
  return (
    ...
    >
      ...
      >
        Bring your visions to life with AI. Create stunning visuals from words
        alone — just describe, and see it unfold.
      </motion.p>
      <motion.button
        onClick={onClickHandler}
        className="sm:text-lg text-white bg-black w-auto mt-8 px-12
          py-2.5 flex items-center gap-2 rounded-full hover:scale-105
      ...
      className="flex felx-wrap justify-center gap-3 mt-16">
        {imageGalary.map((imageSrc, index) => (
          <motion.img
